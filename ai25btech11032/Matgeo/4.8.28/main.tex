...
\begin{align}
\vec{n}_1^\top \vec{r} - c_1 = 0, 
\qquad
\vec{n}_2^\top \vec{r} - c_2 = 0
\end{align}
...
\begin{align}
\big(\vec{n}_1 + k \vec{n}_2\big)^\top \vec{r} - \big(c_1 + k c_2\big) &= 0 \\
\vec{n}(k) &= \vec{n}_1 + k \vec{n}_2 \\
C(k) &= c_1 + k c_2
\end{align}

\textbf{Step 2. Condition for parallelism with $x$-axis}
\begin{align}
\vec{e}_x^\top \vec{n}(k) &= 0 \\
\vec{e}_x^\top \vec{n}_1 + k\, \vec{e}_x^\top \vec{n}_2 &= 0 \\
k &= -\frac{\vec{e}_x^\top \vec{n}_1}{\vec{e}_x^\top \vec{n}_2}
\end{align}

\textbf{Step 3. Required plane}
\begin{align}
\vec{n} &= \vec{n}_1 - \frac{\vec{e}_x^\top \vec{n}_1}{\vec{e}_x^\top \vec{n}_2}\,\vec{n}_2 \\
C &= c_1 - \frac{\vec{e}_x^\top \vec{n}_1}{\vec{e}_x^\top \vec{n}_2}\,c_2 \\
\vec{n}^\top \vec{r} &= C
\end{align}
...
\begin{align}
d &= \frac{\left|\vec{n}^\top \vec{r}_0 - C\right|}{\|\vec{n}\|} \\
&= \frac{|C|}{\|\vec{n}\|}, \quad \text{since } \vec{n}^\top \vec{e}_x = 0
\end{align}

\textbf{Step 5. Substitution of values}
\begin{align}
\vec{e}_x^\top \vec{n}_1 &= 1, & \vec{e}_x^\top \vec{n}_2 &= 2 \\
k &= -\tfrac{1}{2} \\
...
&\big(\vec{n}_1 - \tfrac{1}{2}\vec{n}_2\big)^\top \vec{r} = c_1 - \tfrac{1}{2}c_2 \\
&\Longrightarrow \myvec{0 & -\tfrac12 & \tfrac32}\vec{r} = 3 \\[6pt]
