...
Let the center be $\vec{C}$, and the two endpoints of the diameter be $\vec{A}$ and $\vec{B}$.
\begin{align*}
    \vec{C}=\begin{myvec}{4\\4}\end{myvec} \;, \vec{B}=\begin{myvec}{4\\0} \end{myvec}
\end{align*}
We need to find the coordinates of the other end, $\vec{A} = \begin{myvec}{x\\y}\end{myvec}$.
\end{frame}
...
\end{align*}
To find $\vec{A}$, we can rearrange the equation:
\begin{align*}
    \vec{A} = 2\vec{C} - \vec{B}
\end{align*}
\end{frame}
...
\begin{align*}
\vec{A} &= 2\begin{myvec}{4\\4}\end{myvec} - \begin{myvec}{4\\0} \end{myvec} \\
       &= \begin{myvec}{8\\8}\end{myvec} - \begin{myvec}{4\\0} \end{myvec} \\
       &= \begin{myvec}{4\\8}\end{myvec}
\end{align*}
Thus, the other end of the diameter is $(4, 8)$.
\end{frame}
