...
\end{align}
where $\lambda_3=3$.\\
As the given matrix $\vec{A}$ is symmetric, we can say that the other eigenvectors would be orthogonal to $\myvec{1\\0\\0}$.

\begin{align}
    \therefore \myvec{3&&0&&0\\0&&6&&2\\0&&2&&6}\myvec{0\\1\\1}=8\myvec{0\\1\\1}
\end{align}
where $\lambda_1=8$.Also,
\begin{align}
    \myvec{3&&0&&0\\0&&6&&2\\0&&2&&6}\myvec{0\\1\\-1}=4\myvec{0\\1\\-1}
\end{align}
where $\lambda_2=4$
\newpage
\vspace*{0.25cm}
