...
\\
Any vector of form $\myvec{0\\a\\b}$ will be orthogonal to $\myvec{1\\0\\0}$. Considering $\myvec{0\\1\\1}$ and $\myvec{0\\1\\-1}$ , 

\begin{align}
    \implies \myvec{3&&0&&0\\0&&6&&2\\0&&2&&6}\myvec{0\\1\\1}=8\myvec{0\\1\\1}
\end{align}
