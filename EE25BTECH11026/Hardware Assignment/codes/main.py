...
plt.legend()
plt.tight_layout()
plt.savefig('/home/user/Matrix Theory: workspace/Hardware Assignment/figs/train.png')
plt.show()
plt.close()
...
plt.legend()
plt.tight_layout()
plt.savefig('/home/user/Matrix Theory: workspace/Hardware Assignment/figs/valid.png')
plt.show()
